            ...
            <div className="mb-8">
              ...
              <div className="flex gap-3">
                {[
                  ...
                  { href:'https://lin.ee/5A0tfSQ', label:'LINE', icon:<><path d="M12 3C6.5 3 2 6.6 2 11c0 4 3.6 7.3 8.5 7.9.3.1.8.2.9.5.1.3.1.7 0 1l-.1.9c0 .3-.2 1 .9.6 1.1-.5 6-3.5 8.2-6 1.5-1.7 2.6-3.4 2.6-4.9 0-4.4-4.5-8-10-8z"/></> },
                ].map(({ href, label, icon }) => (

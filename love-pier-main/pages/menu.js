...
const MENU_DATA = [
  {
    ...
    items: [
      ...
      { num:'07', name:'Chicken Rice', desc:'Bowl', price:'35', image:'/menu/food-chicken-rice-bowl.png' },
      { num:'08', name:'Orange Chili Ginger Sauce', desc:'Small jar', price:'25', image:'/menu/food-orange-chili-sauce.png' },
      { num:'09', name:'Ginger Oil Sauce', desc:'Small jar', price:'25', image:'/menu/food-ginger-oil-sauce.png' },
      { num:'10', name:'Soybean Paste Dipping Sauce', desc:'Soybean paste, ginger, fresh chili · small jar', price:'25', image:'/menu/food-soybean-paste-sauce.png' },
      { num:'11', name:'Dine-in Dipping Sauces', desc:'Various sauces for dine-in', price:'Free', image:'/menu/food-dipping-sauces.png' },
    ],
  },
  {
    ...
    items: [
      { num:'01', name:'Pier Breakfast Plate', badge:'Signature', price:'280', image:'/menu/food-pier-breakfast.png' },
  ...
  },
  {
    ...
    items: [
      { num:'01', name:'Americano', prices:{ hot:'90', iced:'100', blended:null }, image:'/menu/real-americano.jpg' },
      ...
      { num:'10', name:'Orange Black Coffee', prices:{ hot:null, iced:'140', blended:null }, image:'/menu/real-orange-americano.jpg' },
      { num:'11', name:'Coconut Coffee', prices:{ hot:null, iced:'140', blended:null }, image:'/menu/real-coconut-americano.jpg' },
    ],
  },
  {
    ...
    items: [
      ...
      { num:'05', name:'Orange Matcha', price:'150', image:'/menu/real-matcha-yuzu.jpg' },
      { num:'06', name:'Matcha Yuzu', price:'150', image:'/menu/matcha-orange.jpg' },
      { num:'07', name:'Soft Matcha', price:'160', image:'/menu/real-soft-matcha.jpg' },
    ],
  },
  {
    ...
    items: [
      ...
      { num:'04', name:'Chocolate Frappe', price:'120', image:'/menu/drink-chocolate-frappe.png' },
  ...
  },
  {
    ...
    items: [
      { num:'01', name:'Coconut Cake', price:'150', image:'/menu/dessert-coconut-cake.png' },
      { num:'02', name:'Strawberry Cheese Pie', price:'189', image:'/menu/dessert-strawberry-cheese-pie.png' },
      { num:'03', name:'Blueberry Cheese Pie', price:'189', image:'/menu/dessert-blueberry-cheese-pie.png' },
      { num:'04', name:'Chocolate Cake', price:'140', image:'/menu/dessert-chocolate-cake.png' },
      { num:'05', name:'Banoffee', price:'150', image:'/menu/dessert-banoffee.png' },
      { num:'06', name:'Red Velvet Cake', price:'130', image:'/menu/dessert-red-velvet.png' },
      { num:'07', name:'Orange Cake', price:'90', image:'/menu/dessert-orange-cake.png' },
      { num:'08', name:'Egg Tart', price:'55', image:'/menu/dessert-egg-tart.png' },

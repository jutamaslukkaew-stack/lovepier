    ...
    <>
      ...
      <section className="px-4 pt-12 pb-10 grid grid-cols-1 lg:grid-cols-[5fr_7fr] gap-9 lg:gap-20 items-start border-b border-black/10 reveal sm:px-6 lg:pt-20 lg:pb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5">
          ...
          <a href="https://lin.ee/5A0tfSQ" target="_blank" rel="noopener noreferrer" className="flex flex-col gap-2 p-6 sm:p-7 lg:p-8 bg-white border border-black/10 hover:bg-[#fffdf6] hover:border-gold transition-all duration-200">
